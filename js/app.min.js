...
var Index=function(){var e=$(window).height(),t=function(){controller=new ScrollMagic.Controller,scene=new ScrollMagic.Scene({triggerElement:".candidates",triggerHook:"onLeave",duration:e}).setTween(TweenLite.to(".portrait",1,{y:150,autoAlpha:0})).addTo(controller),scene=new ScrollMagic.Scene({triggerElement:"#footer",triggerHook:"onEnter",offset:100}).setTween(TweenLite.from("#footer .member",.5,{y:100,ease:Power3.easeOut})).addTo(controller),$(".legislators .content").hide(),$(".legislators .title h3").on("click",function(){$(this).toggleClass("active"),$(".legislators .content").stop().slideToggle()}),function(){var n,e=$(".candidates .bar > div");e.mouseover(function(){n=$(this).find(".tips"),TweenLite.to(n,.2,{scale:1,autoAlpha:1}),e.on("mousemove",function(e){var t=e.target.getBoundingClientRect(),o=e.clientX-t.left;TweenLite.to(n,.1,{x:o})})}),e.mouseout(function(){TweenLite.to(n,.2,{scale:.5,autoAlpha:0})})}()};return{init:function(){t()}}}();